...
class AddEEImageAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self) -> str:
        return """
            ...
            <h3>Parameters:</h3>
            <ul>
                <li><b>Image ID:</b> The Earth Engine asset ID (add link to this page https://developers.google.com/earth-engine/guides/manage_assets) to add to the map (e.g. <code>USGS/SRTMGL1_003</code>).</li>
