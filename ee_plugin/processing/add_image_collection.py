...
class AddImageCollectionAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        ...
        <h3>Parameters:</h3>
        <ul>
            <li><b>Image Collection ID:</b> The Earth Engine Image Collection asset ID (add link to this page https://developers.google.com/earth-engine/guides/manage_assets) to add to the map.</li>
